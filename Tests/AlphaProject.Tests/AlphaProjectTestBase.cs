...
namespace AlphaProject.Tests
{
    public abstract class AlphaProjectTestBase : AbpIntegratedTestBase
    {
        protected AlphaProjectTestBase()
        {
            //Seed initial data
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<AlphaProjectApplicationModule>();
            modules.Add<AlphaProjectDataModule>();
        }

        public void UsingDbContext(Action<AlphaProjectDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<AlphaProjectDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<AlphaProjectDbContext, T> func)
        {
            T result;
